...
const createIcon = (path: React.ReactNode) => {
  return ({ size = 24, strokeWidth = 1.5, ...props }: IconProps) => (
    <svg 
      width={size} 
      height={size} 
      viewBox="0 0 24 24" 
...
export const CloudIcon = createIcon(
  <path d="M17.5 19c2.485 0 4.5-2.015 4.5-4.5S19.985 10 17.5 10c-.15 0-.298.008-.445.023A6.002 6.002 0 0 0 6.06 9.5a4.502 4.502 0 0 0 .44 9.5H17.5z" />
);
